                       ...
                       const wxHtmlCell* const toCell)
{
          ...
          parent; startCell = parent, parent = parent->GetParent() )
    {
        ...
        {
            // Unite rest of current container.
            for ( const wxHtmlCell* nextCell = startCell->GetNext();
                  nextCell; nextCell = nextCell->GetNext() )
            {
                boundingRect.Union(nextCell->GetRect());
