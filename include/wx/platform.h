...
#   define __WXANDROID__
    /*
        If we are not using configure -- which would have defined this symbol
        in setup.h generated by it -- then include the manually maintained file
        containing the HAVE_XXX for Android.
     */
